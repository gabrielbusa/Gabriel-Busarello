...
public class Janela1 {
    ...
    private void initialize() {
        ...
        // Botão para voltar à tela inicial (PaginaInicial)
        JButton btnVoltarInicio = new JButton("Voltar à Página Inicial");
        btnVoltarInicio.setBounds(10, 336, 175, 23);
        frame.getContentPane().add(btnVoltarInicio);

        btnVoltarInicio.addActionListener(e -> {
            frame.dispose(); // Fecha a janela atual (Janela1)
            PaginaInicial.main(null); // Abre a tela inicial (PaginaInicial)
        });
    }
}
